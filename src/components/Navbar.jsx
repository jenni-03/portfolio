...
const Navbar = ({ darkTheme, toggleTheme }) => {
    ...
    const handleEmail = () => {
        const email = 'mailto:jenniferdayanasr@gmail.com'
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 z-10 py-6 backdrop-filter backdrop-blur-md   ${darkTheme ? 'bg-gray-800 text-white bg-opacity-95' : 'bg-white text-gray-900 bg-opacity-70'} `}>
            <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <a href="#about" onClick={handleScroll} className="text-xl font-semibold leading-6  ">
                        Jennifer Salazar <span aria-hidden="true">&rarr;</span>
                    </a>
                </div>
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-12 ">
                    <a href="#about" className="text-xl font-semibold leading-6 " onClick={handleScroll}>
                        About <span aria-hidden="true">&rarr;</span>
                    </a>
                    <a href="#projects" className="text-xl font-semibold leading-6 " onClick={handleScroll}>
                        Projects
                    </a>
                    <a href="#" className="text-xl font-semibold leading-6 " onClick={handleEmail}>
                        Contact
                    </a>
                ...
                <div className="hidden lg:flex justify-end lg:gap-x-12 ml-10">
                    ...
                    <button className={`text-lg font-semibold rounded-full ${darkTheme ? 'text-white bg-violet-900 hover:bg-violet-700 hover:text-white py-2 px-4 border-2 border-violet-900' : 'text-violet-700 hover:bg-violet-400 hover:text-white py-2 px-4 border-2 border-violet-700'} `}
                    ...
                    <div className="mt-6 flow-root">
                        <div className="text-center -my-6 divide-y divide-gray-500/10">
                            <div className="py-6">
                                ...
                                <a href="#" onClick={handleEmail} className={`-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 ${darkTheme ? 'text-white hover:bg-gray-800' : 'text-gray-900 hover:bg-gray-50'}`}>
