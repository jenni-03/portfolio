...
const urlImg =
  "https://raw.githubusercontent.com/jenni-03/portfolio/main/src/assets/";
...
const Project = ({
  ...
  return (
    <div
      className={`px-1 pt-14 mx-auto lg:px-8 ${darkTheme ? "text-white" : ""}`}
    >
      {img ? (
      ...
      <div className="gap-8 pt-4">
        {github && live ? (
          <div className="flex items-center gap-8 pt-4">
            <button
              className={`swing px-6 py-2 border-2 rounded-lg ${
                darkTheme
            ...
            <button
              className={`shakeFix px-6 py-2 border-2 rounded-lg ${
                darkTheme
